...
// 			}
			...
			if(currentLine.size())
			{
				if(currentLine.find("@", 0) == 0)
				{
            		...
            		std::string tmpCurrentLine(currentLine, 1);
					char ** endptr = new char*;
					currentIndex = strtol(tmpCurrentLine.c_str(), endptr, 10);
...
// 			inputSpatialGraph->printTransformation();
		...
		delete [] transformation;
 		...
 		//std::cout << "inputVertices: " << inputVertices.size() << std::endl;
 		//std::cout << "inputEdges: " << inputEdges.size() << std::endl;
 		//std::cout << "tmpVertices: " << tmpVertices.size() << std::endl;
 		//std::cout << "tmpVertexLabels: " << tmpVertexLabels.size() << std::endl;
 		//std::cout << "tmpEdgeConnections: " << tmpEdgeConnections.size() << std::endl;
 		//std::cout << "tmpNoEdgePoints: " << tmpNoEdgePoints.size() << std::endl;
 		//std::cout << "tmpEdgeLabels: " << tmpEdgeLabels.size() << std::endl;
 		//std::cout << "edgePoints: " << edgePoints.size() << std::endl;
 		//std::cout << "edgePointRadius: " << edgePointRadius.size() << std::endl;
	}
